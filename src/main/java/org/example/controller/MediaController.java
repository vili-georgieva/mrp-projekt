...
public class MediaController {
    ...
    private void handleGetMedia(HttpExchange exchange, String path) throws IOException, SQLException {
    ...
    private void handleCreateMedia(HttpExchange exchange, User user) throws IOException, SQLException {
        try {
    ...
    private void handleUpdateMedia(HttpExchange exchange, String path, User user) throws IOException, SQLException {
        String[] parts = path.split("/");
    ...
    private void handleDeleteMedia(HttpExchange exchange, String path, User user) throws IOException, SQLException {
        String[] parts = path.split("/");
        if (parts.length != 4) {
            sendResponse(exchange, 400, "{\"error\":\"Invalid request\"}");
            return;
