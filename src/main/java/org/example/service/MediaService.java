...
public class MediaService {
    ...
    public MediaEntry createMedia(MediaEntry media, User creator) throws SQLException {
    ...
    public MediaEntry updateMedia(int id, MediaEntry updatedMedia, User user) throws SQLException {
    ...
    public void deleteMedia(int id, User user) throws SQLException {
        Optional<MediaEntry> existingOpt = mediaRepository.findById(id);
        if (existingOpt.isEmpty()) {
            throw new IllegalArgumentException("Media entry not found");
        }
    ...
    public Optional<MediaEntry> getMediaById(int id) throws SQLException {
